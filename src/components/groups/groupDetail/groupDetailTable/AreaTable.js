  ...
  const fetchData = async (params = {}) => {
    ...
    try {
      const response = await Api.get(
        `http://localhost:9000/api/v1/group-members/admin/get-group-members?groupId=${group.id}`,
        {
          headers,
          params: {
  ...
  return (
    <>
      <section className="content-area-table">
        <h4 className="data-table-title">Quản lý thành viên nhóm</h4>
        <Button
